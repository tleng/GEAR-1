 ...
 * on 2015-11-01 at 19:10:25 UTC 
 * Modify at your own risk.
 */

package com.appspot.gearbackend.helloworld;
...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://gearbackend.appspot.com/_ah/api/";
  ...
  public class Greetings {
    ...
    public class GetGreeting extends HelloworldRequest<com.appspot.gearbackend.helloworld.model.HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.gearbackend.helloworld.model.HelloGreeting.class);
    ...
    public class ListGreeting extends HelloworldRequest<com.appspot.gearbackend.helloworld.model.HelloGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.gearbackend.helloworld.model.HelloGreetingCollection.class);
      }
     ...
     *
     * @param times
     * @param content the {@link com.appspot.gearbackend.helloworld.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.gearbackend.helloworld.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<com.appspot.gearbackend.helloworld.model.HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.gearbackend.helloworld.model.HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, com.appspot.gearbackend.helloworld.model.HelloGreeting.class);
