...
public class Gear extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the gear library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Gearapi {
    ...
    public class Define extends GearRequest<com.appspot.backendgear_1121.gear.model.GearBackendDefinition> {
      ...
      private static final String REST_PATH = "gearapi/define";
    ...
    /**
     * Create a request for the method "gearapi.sendJsonData".
     *
     * This request holds the parameters needed by the gear server.  After setting any optional
     * parameters, call the {@link SendJsonData#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.backendgear_1121.gear.model.GearBackendJsonData}
     * @return the request
     */
    public SendJsonData sendJsonData(com.appspot.backendgear_1121.gear.model.GearBackendJsonData content) throws java.io.IOException {
      SendJsonData result = new SendJsonData(content);
      initialize(result);
      return result;
    }

    public class SendJsonData extends GearRequest<com.appspot.backendgear_1121.gear.model.GearBackendJsonData> {

      private static final String REST_PATH = "gearapi/json";

      /**
       * Create a request for the method "gearapi.sendJsonData".
       *
       * This request holds the parameters needed by the the gear server.  After setting any optional
       * parameters, call the {@link SendJsonData#execute()} method to invoke the remote operation. <p>
       * {@link
       * SendJsonData#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @param content the {@link com.appspot.backendgear_1121.gear.model.GearBackendJsonData}
       * @since 1.13
       */
      protected SendJsonData(com.appspot.backendgear_1121.gear.model.GearBackendJsonData content) {
        super(Gear.this, "POST", REST_PATH, content, com.appspot.backendgear_1121.gear.model.GearBackendJsonData.class);
      }

      @Override
      public SendJsonData setAlt(java.lang.String alt) {
        return (SendJsonData) super.setAlt(alt);
      }

      @Override
      public SendJsonData setFields(java.lang.String fields) {
        return (SendJsonData) super.setFields(fields);
      }

      @Override
      public SendJsonData setKey(java.lang.String key) {
        return (SendJsonData) super.setKey(key);
      }

      @Override
      public SendJsonData setOauthToken(java.lang.String oauthToken) {
        return (SendJsonData) super.setOauthToken(oauthToken);
      }

      @Override
      public SendJsonData setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SendJsonData) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SendJsonData setQuotaUser(java.lang.String quotaUser) {
        return (SendJsonData) super.setQuotaUser(quotaUser);
      }

      @Override
      public SendJsonData setUserIp(java.lang.String userIp) {
        return (SendJsonData) super.setUserIp(userIp);
      }

      @Override
      public SendJsonData set(String parameterName, Object value) {
        return (SendJsonData) super.set(parameterName, value);
      }
    }
